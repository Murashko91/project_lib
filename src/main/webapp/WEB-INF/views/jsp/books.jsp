...
<jsp:useBean id="bookList" class="by.sergey.murashko.entities.BookList" scope="page"/>
...
<div class="book_list">
    ...
    <div class="book_info">
        ...
        <div class="book_image">
            <a href="<%=request.getContextPath()%>/DownloadBook?index=<%=list.indexOf(book)%>"><img src="<%=request.getContextPath()%>/ShowImage?index=<%=list.indexOf(book)%>" height="250" width="190" alt="Обложка"/></a>
        </div>
        <div class="book_details">
            ...
            <p style="margin:10px;"> <a href="<%=request.getContextPath()%>/DownloadBook?index=<%=list.indexOf(book)%>">Читать</a></p>
        </div>
    </div>
